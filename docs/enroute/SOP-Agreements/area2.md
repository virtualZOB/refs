...
| DTW                     | Arrivals         | 2                 | KDTW arrivals descending to FL240 from HUD sector may be issued discretionary descents by DRE sector. HUD sector is responsible for advising DRE sector when discretionary descents cannot be approved. |
