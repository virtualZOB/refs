...
<div id="quiz">
    <div class="question-container" data-correct=".COMMANDS" data-type="ZOB WEBSITE REFERENCE">
        ...
        <button class="check-answer" style="background-color: #04AA6D;">Check Answer</button>
...
<div class="navigation">
    <button id="prev" style="background-color: #04AA6D">Previous</button>
    <button id="next" style="background-color: #04AA6D">Next</button>
</div>
